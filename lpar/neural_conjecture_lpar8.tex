...
442 hard \Mizar problems unsolved by Vampire or E before, and speeds up 2,236 further
problems.\footnote{The development of the neural architectures and the paper writing has used Claude Code and Codex in multiple human-supervised sessions. The experiments and evaluations were conducted by humans.}
\end{abstract}
...
shows continued improvement.  With only 16 conjectures from a model
trained on its own verified outputs, the second iteration adds 50
new hard problems beyond the first, bringing the cumulative total
to \textbf{1,112}---an 80\% increase over the baseline of 620.
...
4,499 problems solved and \textbf{1,221 hard problems}, roughly
...
+ 2nd iter.\ conj.\ (16, combined)     & 4,379 & 1,112 \\
+ CASC portfolio                        & \textbf{4,499} & \textbf{1,221} \\
\bottomrule
\end{tabular}
\end{table}
...
reaches 1,221 hard problems.  These results suggest that learned cut formulas capture
