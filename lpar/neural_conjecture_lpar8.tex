...
the system already produces reusable training data from its own verified
successes.
...
saturation-based theorem provers.  The generated formulas are speculative but soundly
